...
const ClientSlider = ({clients}) => {
  return (
    <Swiper slidesPerView={1} spaceBetween={30} grabCursor={true}
    loop={true} breakpoints={{
      ...
      {clients.map((client,index) => {
        ...
        //slide
        return (
          <SwiperSlide key={index} style={{borderColor:
            borderColor}} className='border-t-[10px]
            rounded-t-[12px]'>
              <div className='w-full mx-auto lg:max-w-[300px]
              x1:max-w-[350px] h-[250px] rounded-[12px]
